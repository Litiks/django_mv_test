...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MVProfile.user_agent'
        db.add_column(u'mv_test_mvprofile', 'user_agent',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MVProfile.user_agent'
        db.delete_column(u'mv_test_mvprofile', 'user_agent')
